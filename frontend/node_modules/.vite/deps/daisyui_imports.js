...
var object_default = { "@property --radialprogress": { "syntax": '"<percentage>"', "inherits": "true", "initial-value": "0%" } };
...
var properties_default = ({ addBase, prefix = "" }) => {
  const prefixedproperties = addPrefix(object_default, prefix);
  addBase({ ...prefixedproperties });
};

// node_modules/daisyui/base/scrollbar/object.js
var object_default2 = { ":root": { "scrollbar-color": "color-mix(in oklch, currentColor 35%, #0000) #0000" } };

// node_modules/daisyui/base/scrollbar/index.js
var scrollbar_default = ({ addBase, prefix = "" }) => {
  const prefixedscrollbar = addPrefix(object_default2, prefix);
  addBase({ ...prefixedscrollbar });
};

// node_modules/daisyui/base/rootscrolllock/object.js
var object_default3 = { ':root:has( .modal-open, .modal[open], .modal:target, .modal-toggle:checked, .drawer:not([class*="drawer-open"]) > .drawer-toggle:checked )': { "overflow": "hidden" } };

// node_modules/daisyui/base/rootscrolllock/index.js
var rootscrolllock_default = ({ addBase, prefix = "" }) => {
  const prefixedrootscrolllock = addPrefix(object_default3, prefix);
  addBase({ ...prefixedrootscrolllock });
};

// node_modules/daisyui/base/rootcolor/object.js
var object_default4 = { ":root, [data-theme]": { "background-color": "var(--root-bg, var(--color-base-100))", "color": "var(--color-base-content)" } };
...
var object_default6 = { ":where( :root:has( .modal-open, .modal[open], .modal:target, .modal-toggle:checked, .drawer:not(.drawer-open) > .drawer-toggle:checked ) )": { "scrollbar-gutter": "stable", "background-image": "linear-gradient(var(--color-base-100), var(--color-base-100))", "--root-bg": "color-mix(in srgb, var(--color-base-100), oklch(0% 0 0) 40%)" } };
